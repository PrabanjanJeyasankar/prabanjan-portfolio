    ...
    <div
      ...
      <div className={contactFormStyles.contact_form_header}>
        ...
        <p className={contactFormStyles.subtitle}>
          If my work speaks to you, consider hiring me! I’m all ears for any
          ideas or projects you’d like to discuss{' '}
          <a
      ...
      {successMessage && (
        <p className={contactFormStyles.success_message}>{successMessage}</p>
      )}
      {errorMessage && (
      ...
      <form
        ...
        <div className={contactFormStyles.input_group}>
          <input
            ...
            className={`${contactFormStyles.input} ${
              errors.user_name ? contactFormStyles.error_input : ''
            }`}
            onChange={handleInputChange}
          />
          {errors.user_name && (
            <p className={contactFormStyles.error_name}>{errors.user_name}</p>
          )}
        </div>
        ...
        <div className={contactFormStyles.input_group}>
          <input
            ...
            placeholder='Email'
            className={`${contactFormStyles.input} ${
              errors.user_email ? contactFormStyles.error_input : ''
            }`}
            onChange={handleInputChange}
          />
          {errors.user_email && (
            <p className={contactFormStyles.email_error}>{errors.user_email}</p>
          )}
        </div>
        ...
        <div className={contactFormStyles.input_group}>
          ...
          />
          {errors.message && (
            <p className={contactFormStyles.message_error}>{errors.message}</p>
          )}
        </div>
