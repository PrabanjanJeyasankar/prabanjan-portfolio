const experiences = [
...

  {
    ...
    responsibilities:
      ' Working closely with the founding team in a lean startup environment to build in-house products across multiple tech stacks. Contributed to both frontend and backend development, collaborated on product planning, and participated in design, implementation, and testing of features',
    impact:
      ' Contributing faster feature delivery and smoother development cycles by owning key parts of the product and adapting quickly to changes.',
  },
  {
    type: 'professional',
    ...
    impact:
      'Achieved a significant reduction in user friction by implementing intuitive interface designs, resulting in a 20% increase in user engagement.',
